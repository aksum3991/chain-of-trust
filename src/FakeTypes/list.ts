...
export const initialStaffs:User[] = [
  {
    id: "user_1",
    email: "user1@example.com",
    firstName: "John",
   ...
   export   const initalRequest = [
        {
          ...
          approved: false,
          user: initialStaffs[0],
          asset: initialAssets[0],  // No asset ID for new asset request
          type: "New Asset",
...
export const initialAssetRequest:AssetRequest[] = [
    {
        id: "request_3",
        createDatetime: new Date("2024-03-18T10:00:00Z"),
        resolveDatetime:undefined,
      ...
      },
      {
        ...
        approved: true,
        user: initialStaffs[0],
        asset: initialAssets[1],  // Requesting maintenance for existing asset
        // type: "Existing Asset",
        // quantity: 1,  // Quantity of 1 (implicitly understood for existing asset)
        rejected: false,
        rejectionReason: undefined,
...
export const initialMaintenanceRequest = [
            {
            id: "request_6",
            createDatetime: new Date("2024-03-18T11:15:00Z"),
            resolveDatetime: undefined,
            approved: false,
            user: initialStaffs[0],
            asset: initialAssets[0],  // Requesting maintenance for existing asset
            rejected: false,
            rejectionReason: undefined,
            questionReason:"Lorem ipsum dolor sit amet consectetur, adipisicing elit. Saepe omnis id aperiam? Sunt, minima. Facere in ullam ut quam modi.",
          },
